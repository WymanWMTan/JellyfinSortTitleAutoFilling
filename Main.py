from ListNFOFile import find_files_with_suffix
from ReadNFOFile import Read_NFO_tag_value
from TranslateTitleToPinyin import to_pinyin
from UpdateNFOFile import write_NFO_tag_value

# 指定的电影或者电视文件夹，目标找到里面包含的所有.nfo文件
directory_path = "G:\\TEMP"
suffix = '.nfo'
